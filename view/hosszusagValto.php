                ...
                <form action="">
                    ...
                    <div class="mt-2 d-flex align-items-center">
                        ...
                        <select class="form-select ms-2" aria-label="Default select example" id="mirol" name="mirol">
                            <?php foreach ($hosszusagok as $hosszusag) { ?>
                                <option
                                    value="<?php echo $hosszusag['id'] ?>"
                                    <?php echo ($mirol === $hosszusag['id'] ? "selected" : "") ?>>
                                    <?php echo $hosszusag['id'] ?>
                    ...
                    <div class="mt-2 d-flex align-items-center">
                        ...
                        <select class="form-select ms-2" aria-label="Default select example" id="mire" name="mire">
                            <?php foreach ($hosszusagok as $hosszusag) { ?>
                                <option
                                    value="<?php echo $hosszusag['id'] ?>"
                                    <?php echo ($mire === $hosszusag['id'] ? "selected" : "") ?>>
                                    <?php echo $hosszusag['id']?>
                                </option>
                            <?php } //end for 
                            ?>
